...
[Obsidian](https://obsidian.md) is a **local-first Markdown editor** built around bidirectional linking. Every note lives as a plain `.md` file on your disk — no proprietary format, no cloud lock-in. Its graph view visualises how your ideas connect, and its plugin ecosystem (Dataview, Templater, Tasks, and more) turns a flat folder of notes into a structured, queryable knowledge base.
...
This combination is especially powerful if you're a student or early-career professional — where the surface area of things to learn is enormous and retention is everything.
...
**Technical skill-building:** Learning a new framework or language? Every time you solve a problem or read a doc, capture it. Claude organizes your learnings into permanent notes in `30_Resources/Systems/`. Before a project or interview, query the vault — your past self has already done the research.

**Career and interview prep:** Notes from mock interviews, feedback from mentors, system design patterns — all captured, organized, and queryable. Ask Claude to synthesize "what do I know about behavioral interview answers" before your next round.

**Writing and communication:** Blogs, technical write-ups, cover letters — Claude can draft these by pulling from your vault's existing notes. Your writing becomes faster and more original because it's grounded in *your* thinking, not generic templates.
...
One of the most useful capture workflows starts in the browser. The **[Obsidian Web Clipper](https://obsidian.md/clipper)** is a browser extension that lets you clip any web page — an article, a documentation page, a blog post, a research paper — directly into your vault's inbox as a clean Markdown file. One click, no copy-pasting.
...
* **Core Book:** [Building a Second Brain — Tiago Forte](https://www.buildingasecondbrain.com/)
